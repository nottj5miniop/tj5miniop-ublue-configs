...
It's hosted on this account instead of my main (github.com/tj5miniop) as there are  issues with repo sizes
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  rpm-ostree rebase ostree-unverified-registry:ghcr.io/nottj5miniop/tj5miniop-ublue:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  rpm-ostree rebase ostree-image-signed:docker://ghcr.io/nottj5miniop/tj5miniop-ublue:latest
  ```
